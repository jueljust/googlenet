...
define_py_data_sources2("train.list", None, module="provider", obj="process", args=args)
...
if not is_predict:
    ...
    conv_o1 = img_conv_layer(
        ...
        padding=0,
        bias_attr=bias_attr,
        param_attr=xavier(pool_o1.num_filters, 1)
    )
    fc_o1 = fc_layer(
        name="fc_o1",
        input=conv_o1,
        size=1024,
        layer_attr=ExtraAttr(drop_rate=0.7),
        act=ReluActivation(),
    ...
    conv_o2 = img_conv_layer(
        ...
        padding=0,
        bias_attr=bias_attr,
        param_attr=xavier(pool_o2.num_filters, 1)
    )
    fc_o2 = fc_layer(
        name="fc_o2",
        input=conv_o2,
